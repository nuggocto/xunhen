...
func TestFiniteBudgets(t *testing.T) {
	...
	tests := []struct {
		...
		{"unlimited replay headers", func(l *limits.Limits) { l.ReplayHeaders = 0 }, false},
		{"excess replay entries", func(l *limits.Limits) { l.ReplayEntries++ }, false},
		{"negative replay moves", func(l *limits.Limits) { l.ReplayMoves = -1 }, false},
